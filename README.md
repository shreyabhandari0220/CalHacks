...
# How we built it
We leveraged Supervised Machine Learning techniques and statistical correlation of particular LOINC values from FIHR API to predictively model risk assessment. 
